...

{
    ...
    public function create(){
        ...
        $est = $this->est;
        return view('ficha.create',compact('jornada','formacion','aprendices', 'est'));
    }
    ...
    public function edit($id_ficha){
        ...
        $est =  $this->est;
        return view('ficha.edit', compact('ficha', 'jornada', 'formacion', 'aprendices', 'est'));
    }
  ...
  public function show($id_ficha){
        ...
        $jornada = Jornada::all();
        $programa = Formacion::all();
        $aprendiz = Aprendices::all();
        $est = $this->est;
        return view('ficha.show', compact('ficha','jornada', 'formacion', 'aprendices', 'est'));
    } 
